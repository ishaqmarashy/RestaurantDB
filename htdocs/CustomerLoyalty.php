...
$first = $_POST['first'];
$last = $_POST['last'];
$query = "SELECT RESTAURANTNAME, POINTS,(points*0.05) AS DISCOUNT FROM LOYALTY A,CUSTOMERINFO B WHERE B.FIRSTNAME='$first' and B.LASTNAME='$last' AND B.CUSTOMERID=A.CUSTOMERID;";
