...
$RID = $_POST['RID'];
$query = "SELECT PRODUCTID,PRODUCTNAME FROM RESTAURANT A,PRODUCT B WHERE A.RESTAURANTNAME=B.RESTAURANTNAME AND A.RESTAURANTNAME= '$RID'";
$result = runQuery($connection,$query);
$numrows = mysqli_num_rows($result);
if ($numrows == 0) 
{
	print "No Restaurant With Name = $RID";
	print "</body></html>";
	exit();
}
print "<h3> Restaurant With Name = $RID</h3>";
displayTable($result);
?>
