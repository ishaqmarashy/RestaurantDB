...
<h1>Search Customer Orders database: </h1>
<p>
<br/>
<form method = "post" action = "DisplayOneCustomer.php" >
Enter ID of the customer you wish to know about: <input type = "text" size = "10" name = "CUSTOMERID" />
