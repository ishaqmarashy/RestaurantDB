...
<table>
<tr>  
 <td> <input type="text" size="20" name="first" placeholder="FirstName" /> </td> </tr>
 <tr>  
<td> <input type="text" size="20" name="last" placeholder="LastName" /> </td> </tr>
<tr> 
<td> <input type="text" size="50" name="add" placeholder="Address" /> </td> </tr>
<tr> 
<td> <input type="text" size="50" name="email" placeholder="Email" /> </td> </tr>
<tr> 
<td> <input type="text" size="10" name="doB" placeholder="Date Of Birth" /> yyyy-mm-dd</td> </tr>
<tr> <br/> </td>
<td> <input type="text" size="10" name="regdate" placeholder="Registration Date" /> </td> </tr>
<tr> <td>Gender </td>
<td> Male  :<input type="radio" value="M" name="gen"/><br/>
...
$query = 'SELECT CUSTOMERID FROM CUSTOMERINFO';
